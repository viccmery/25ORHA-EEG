...
def decode_supracat(data, subject, n_perms=100, n_pstrials=4, n_test=1):
    ...
    DA = np.full((n_cat, n_cat, n_time), np.nan)  # array to contain the resulting decoding accuracy
...
if __name__ == '__main__':
    ...
    if sys.platform == 'darwin':
        dirs = {
            "out": r"C:\Users\victo\Desktop\MRes\25MResButler\250129pilot\results\decode_supracat",
    ...
    out_dict = decode_supracat(data, subject)

    out_file = os.path.join(dirs['out'], f"dec_sup_{subject}_uv1.pkl")
